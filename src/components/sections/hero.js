...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Adithya Viswanath.</h2>;
  const three = <h3 className="big-heading">I solve problems, write code, and some more.</h3>;
  const four = (
    <>
      <p>
